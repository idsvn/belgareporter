...
public class FileController {
    ...
    public ResponseEntity createFile(@RequestHeader("upload-metadata") String metadata) {
        ...
        FileUpload fileUpload = fileService.createFile(map.get("filename"));
        URI location = URI.create("file/" + fileUpload.getId());
        return ResponseEntity.created(location)
                .header(TUS_HEADER_NAME, TUS_HEADER_VALUE)
                .build();
    }
    ...
    public ResponseEntity patchFile(@PathVariable int fileId,
